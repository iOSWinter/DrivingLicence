...
{
    return self.faf_underlineFromCamel;
}

- (NSString *)camelFromUnderline
{
    return self.faf_camelFromUnderline;
}

- (NSString *)firstCharLower
{
    return self.faf_firstCharLower;
}

- (NSString *)firstCharUpper
{
    return self.faf_firstCharUpper;
}

- (BOOL)isPureInt
{
    return self.faf_isPureInt;
}
