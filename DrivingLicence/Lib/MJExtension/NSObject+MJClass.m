...
{
    [self faf_setupBlockReturnValue:ignoredPropertyNames key:&MJIgnoredPropertyNamesKey];
}

+ (NSMutableArray *)faf_totalIgnoredPropertyNames
{
    return [self faf_totalObjectsWithSelector:@selector(faf_ignoredPropertyNames) key:&MJIgnoredPropertyNamesKey];
}

#pragma mark - 归档属性黑名单配置
+ (void)faf_setupIgnoredCodingPropertyNames:(MJIgnoredCodingPropertyNames)ignoredCodingPropertyNames
{
    [self faf_setupBlockReturnValue:ignoredCodingPropertyNames key:&MJIgnoredCodingPropertyNamesKey];
}

+ (NSMutableArray *)faf_totalIgnoredCodingPropertyNames
{
    return [self faf_totalObjectsWithSelector:@selector(faf_ignoredCodingPropertyNames) key:&MJIgnoredCodingPropertyNamesKey];
}

#pragma mark - 属性白名单配置
+ (void)faf_setupAllowedPropertyNames:(MJAllowedPropertyNames)allowedPropertyNames;
{
    [self faf_setupBlockReturnValue:allowedPropertyNames key:&MJAllowedPropertyNamesKey];
}

+ (NSMutableArray *)faf_totalAllowedPropertyNames
{
    return [self faf_totalObjectsWithSelector:@selector(faf_allowedPropertyNames) key:&MJAllowedPropertyNamesKey];
}

#pragma mark - 归档属性白名单配置
+ (void)faf_setupAllowedCodingPropertyNames:(MJAllowedCodingPropertyNames)allowedCodingPropertyNames
{
    [self faf_setupBlockReturnValue:allowedCodingPropertyNames key:&MJAllowedCodingPropertyNamesKey];
}

+ (NSMutableArray *)faf_totalAllowedCodingPropertyNames
{
    return [self faf_totalObjectsWithSelector:@selector(faf_allowedCodingPropertyNames) key:&MJAllowedCodingPropertyNamesKey];
}
...
+ (NSMutableArray *)faf_totalObjectsWithSelector:(SEL)selector key:(const char *)key
{
